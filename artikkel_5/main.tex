...
Denne kappa har tre oppg\aa{}ver: (1)~syntetisere beviskjeda til \'{e}i samanhengande forteljing, (2)~demonstrere at FFF er eit fullstendig paradigmeskifte i Kuhn si tyding \citep{kuhn1962}, ikkje berre ein korreksjon, og (3)~vise at rammeverket generaliserer fr\aa{} stolar til alle estetiske fag.
...
\noindent
Designaren er ikkje ein eineveldig skapar, men \'{e}in agent i eit distribuert system. Forma som kjem ut er ikkje \'{e}in person sin intensjon, men eit \emph{emergent resultat} av mange samverkande seleksjonstrykk, nett slik slimsoppen sitt optimale nettverk er eit emergent resultat av mange samverkande celler.
...
Beviskjeda har klare avgrensingar: (1)~\'{e}i samling fr\aa{} \'{e}itt museum; (2)~\'{e}in objekttype (stolar); (3)~museumsseleksjonsskaevheit (prestisje\-objekt overrepresentert); (4)~handlaga geometriske features, ikkje end-to-end deep learning; (5)~$n = 93$ med komplett data for MI-analysen i Art.~IV; (6)~dateringane er i mange tilfelle estimat. Trass i desse avgrensingane er beviskjeda kumulativ: kvar artikkel brukar ulike metodar p\aa{} ulike delsett av same samling, og konklusjonane konvergerer.
...
Beviskjeda er kumulativ og konvergent. Materialar er ikkje n\o{}ytrale medium, men agentar med eigen affordanse (Art.~I). Stilar migrerer langs maktgeografiske linjer, ikkje etter formell logikk (Art.~II). Form kodar kulturell identitet og historisk tid i 3D-geometri (Art.~III). Fitnesslandskapet er reelt, m\aa{}lbart og dynamisk, med material som det st\o{}rste seleksjonstrykket og funksjon som det minste (Art.~IV).
