...
Konsekvensen er at formhistoria ikkje er ein jamn progresjon mot eit funksjonelt optimum, men ein serie navigeringar i stadig skiftande terreng. \citet{frazer1995} var den fyrste designteoretikaren som eksplisitt kopla evolusjonær modellering til arkitektur, men utan eit empirisk datasett. STOLAR-prosjektet gjev det empiriske grunnlaget.
...
\begin{figure}[H]
  ...
  \caption{Fellesinformasjon med stilperiode. Proporsjonar ber 51,9\,\% av all stilinformasjon (MI = 2,072 bits). Funksjon ber null.}
  \label{fig:mi}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{fig4_jaccard.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{fig9_nmk_va_hogde.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{fig8_teknikk_entropi.pdf}
