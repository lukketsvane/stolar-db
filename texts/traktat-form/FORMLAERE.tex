...
Proposisjonane er pr\o vde mot eit datasett p\aa\ om lag 2300 europeiske stolar fr\aa\ Nasjonalmuseet og Victoria and Albert Museum, som spenner fr\aa\ 1280 til 2024 \citep{finne2026}. Kvar generell p\aa stand har s\aa leis ein empirisk ber\o ringsflate i stolformene. Men teksten er ikkje avgrensa til stolar: ho gjeld kvar form som oppst\aa r under avgrensande vilk\aa r.
...
\subsubprop{1.21} Formrommet er ikkje ein abstraksjon. Det er den reelle mengda av alle moglege kombinasjonar av geometri, materiale og konstruksjon \citep[jf.][]{raup1966, thompson1917}. Kvar dimensjon svarar til ein eigenskap som kan variere. Kvar realisert gjenstand er eitt punkt i dette rommet.
...
\subsubprop{1.24} Dei busette regionane utgjer ein forsvinnande liten del av formrommet. I kvart system som er unders\o kt, fr\aa\ biologiske skjelformer \citep{raup1966} til datalagde stolmodellar \citep{finne2026}, okkuperer dei realiserte formene under \'ein prosent av det teoretisk moglege rommet.
...
\subsubprop{2.19} Kvar av desse er eit \textit{seleksjonstrykk}: ein faktor som endrar sannsynlegheitsfordelinga over formrommet \citep[jf.][]{wright1932, kauffman1993}. Funksjonen (2.16) er eitt slikt trykk. Han er reell. Men han er berre eitt blant fleire.
...
\subsubprop{2.22} Sj\aa\ p\aa\ kva stol som helst: dei har alle same funksjon, men radikalt ulike former \citep[sjå][for ei systematisk oversikt]{fiell2012}. Dette er eit empirisk faktum. Det stadfestar at fleire uavhengige seleksjonstrykk enn funksjon verkar.

\subsubprop{2.23} Innanfor klassen ``stol'' varierer volumet med ein faktor p\aa\ fleire hundre \citep{finne2026}. Same funksjon, radikalt ulik utstrekning. H\o gda ber over eitt bit gjensidig informasjon med stilperioden \citep[jf.][]{shannon1948, cover2006}. Funksjonen, som er konstant, ber null.
...
\subprop{2.5} Kvart seleksjonstrykk ber ein m\aa lbar mengd informasjon om den endelege forma \citep[jf.][]{shannon1948}. Ein maskinl\ae ringsmodell \citep[jf.][]{breiman2001} som brukar materiale, tid og produksjonsland oppn\aa r vesentleg betre treffsikkerheit enn ein som berre brukar funksjon \citep{finne2026}. Forklaringskrafta ligg i kombinasjonen, ikkje i einskildfaktorane.

\subsubprop{2.51} Formelen ``form f\o lgjer funksjon'' \citep{sullivan1896} er ikkje feil. Ho er eit grensetilfelle \citep[sjå][for ei historisk-kritisk lesing]{michl_fff}: ho gjeld berre der eitt einaste seleksjonstrykk dominerer s\aa\ sterkt at alle andre er negligerbare. I den reelle verda er dette unntaket, ikkje regelen.

% ============================================
\prop{3 Kreftene lagar eit tilpassingslandskap.}

\subprop{3.1} Seleksjonstrykka verkar ikkje kvar for seg; dei definerer saman eit \textit{tilpassingslandskap} over formrommet \citep{wright1932, kauffman1993, gavrilets2004}. Kvar posisjon i formrommet har ein verdi: kor godt forma tilfredsstiller alle verksame trykk samstundes.
...
\subsubprop{3.13} Talet p\aa\ haugar i landskapet aukar med talet p\aa\ samverkande seleksjonstrykk \citep[jf.\ NK-modellen i][]{kauffman1993}. Eitt trykk \aa leine gjev \'ein haug. Fleire uavhengige trykk som verkar samstundes gjev mange haugar. Jo fleire gjensidig avhengige trykk, jo meir ulendt vert landskapet.
...
\subsubprop{3.23} Eit arketype som dukkar opp uavhengig i tradisjonar utan kontakt, er sterkt prov for at haugen er ein eigenskap ved landskapet, ikkje ved nokon einskild vandrar \citep[jf.\ konvergent evolusjon i][]{conwaymorris2003}.
...
\subprop{4.6} Landskapet har minne \citep[jf.][]{boyd1985, henrich2016}. Kvar realisert form etterlet seg eit spor: eit fysisk objekt, ein produksjonsmetode, ei forventning, ein vane. Sporet vert sj\o lv ein del av seleksjonstrykka for neste form \citep[jf.][]{kubler1962}.

\subprop{4.7} Endringa i landskapet er ikkje jamn. Lange periodar med sm\aa\ justeringar vert avbrotne av br\aa\ opningar: ein ny teknologi gjer tilgjengeleg ein heil region som f\o r var forboden. M\o nsteret er eit av stase og brot \citep[jf.\ \textit{punctuated equilibrium} i][]{eldredge1972}.

\subsubprop{4.71} Etter kvart brot f\o lgjer ei rask spreiing av nye former inn i den nyopna regionen, deretter ei gradvis innsnevring mot nye haugar. Dampb\o ying \citep[jf.][]{thonet1976} opna \'ein region; r\o yrst\aa l ein annan \citep{wilk1981}; spr\o ytest\o yping ein tredje. Kvar gong var m\o nsteret det same.

% ============================================
\prop{5 Materialet deltek i \aa\ avgjere forma.}

\subprop{5.1} Den r\aa dande modellen i formfaga har vore at formgjevaren tenkjer, og materialet lystrer \citep[jf.\ den hylomorfiske modellen kritisert av][]{ingold2013}. At form vert p\aa f\o rt materie utanfr\aa: ein plan fr\aa\ ein hjerne, utf\o rt p\aa\ eit passivt stoff.

\subsubprop{5.11} Denne modellen er utilstrekkeleg \citep[sjå][for ei systematisk materialanalyse]{ashby2013}. Ho kan ikkje forklare kvifor same formgevar, med same intensjon og same funksjonskrav, produserer radikalt ulike former i ulike materialar \citep[jf.\ omgrepet \textit{affordance} hos][]{gibson1977}.

\subsubprop{5.12} Skiljet mellom den som tenkjer og det som vert tenkt p\aa, er ikkje skarpt. Det er graduelt \citep[jf.][]{levin2022, levin2019}. Det finst ein samanhengande skala fr\aa\ system som berre kan endrast ved \aa\ omkalfatre maskinvara, via system der parametrane kan justerast, til system som justerer seg sj\o lve.
