...
\subsection{Modulor i PCA-rommet: ein 1,5-sigma uteliggar}

PCA-analyse av dei tre hovuddimensjonane (H, W, D) for 1\,880 stolar syner at Modulor-punktet (113, 53, 43) er ein \textbf{1,5-sigma uteliggar}: 62,1\,\% av alle stolar ligg naerare den empiriske sentroiden enn Modulor. Regence (avstand 1,8) og barokk (3,1) ligg naermast Modulor i PCA-rommet. Funksjonalisme ligg lengst vekk (37,2), trass i at Modulor var meint som eit modernistisk verktoy. Modulor beskriv den foer-modernistiske stolen; den modernistiske stolen har flytta seg vekk.
