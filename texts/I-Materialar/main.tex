...
Denne bogen er ikkje ein stilistisk preferanse. Det er eit \textbf{materielt avtrykk av den transatlantiske handelsøkonomien} \citep[jf.][]{anderson2012, bowett2012}. The Naval Stores Act av 1721 fjerna tollsatsar paa tropisk hardved og demokratiserte tilgangen utover London \citep{bowett2012}. Kulminasjonen i 1825--1849 fell saman med perioden etter abolisjonen av slaveriet i det britiske imperiet (1833/34). Kollapsen reflekterer den globale uttomminga av kommersiell mahogni \citep{anderson2012}, som forte til at alle tre \emph{Swietenia}-artane vart plasserte paa CITES sine vernelister. Toppunktet fell saman med perioden der Storbritannia sin kontroll over karibisk og sentralamerikansk tømmer var på sitt sterkaste, og der norske snikkarar hadde størst tilgang til mahogni gjennom britiske mellomledd. Fallet etter 1850 korresponderer med utarming av dei lett tilgjengelege tropiske skogane og framveksten av industrielle erstatningsmateriaal.
...
Denne suksesjonen er ikkje tilfeldig \citep[jf.][]{headrick2009}. Kvart materiale krev ein ny teknikk som igjen opnar nye regionar i formrommet: st\aa l krev sveising og r\o yrb\o ying; bj\o rk krev dampb\o ying og laminering; glasfiber krev st\o yping. Materialsuksesjonen er samstundes ein teknikksuksesjon og ein formsuksesjon.
