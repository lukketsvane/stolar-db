...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{fig1_mahogni_boge.pdf}
...
Materialkommentar-feltet i databasen gjev oss endå finare oppløysing. 19 stolar har spesifisert \emph{cubamahogni} (\emph{Swietenia mahagoni}), alle frå 1820. Ytterlegare 24 stolar er beskriven med \emph{mahognifiner} (tynn fasade finert på billegare tre), og 11 med \emph{beiset mahogni} (lokalt tre farga for å imitere mahogni). Denne graderinga avslører eit treledda hierarki: \emph{massiv cubamahogni} (dyrast, mest prestisjefull), \emph{mahognifiner} (eit kompromiss), og \emph{beiset imitasjon} (den billegaste kolonialsimulakringen). Materiell dobbeltheit er ikkje eit binært fenomen; det er eit kontinuum av kolonialt engasjement.

\subsection{Entropi-kurva: tre regime}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{fig2_entropi.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{fig3_materialkategoriar.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{fig4_jaccard.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{fig10_dobbeltheit.pdf}
  \caption{Materiell dobbeltheit: andel stolar som kombinerer lokalt berande tre med importert fasademateriale.}
...
Kulminasjonspunktet ved 100\,\% i 1825--1849 er ikkje berre eit statistisk kuriosum. Det er eit symptom på kva \citet{wallerstein2004} kalla eit \textbf{verdsystem} der perifere handverkarar er fullstendig avhengige av sentrum sine materialstraumar. Den norske snikkaren i 1830 har \emph{ikkje val}: han lagar stolen av mahogni fordi det er det materialet som er tilgjengeleg, prissett og estetisk forventa. Stolen er ikkje kolonial fordi snikkaren vel det; han er kolonial fordi \emph{materiallandskapet} er kolonialt.
