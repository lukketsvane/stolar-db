...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{fig5_hogde_modulor.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{fig6_hw_ratio.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{fig12_chi2_residualar.pdf}
  \caption{Nasjonale materialfingeravtrykk: standardiserte $\chi^2$-residualar. Raude celler syner overrepresentasjon, blaae underrepresentasjon. Noreg er sterkt assosiert med bjork ($+10{,}8$) og furu ($+8{,}2$); Storbritannia med mahogni ($+4{,}3$).}
  \label{fig:chi2}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{fig14_dimensjonsdrift.pdf}
