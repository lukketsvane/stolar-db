...
\ordlisteentry{Innleiring (Embedding)}{Ein euklidsk transformasjon som beviser at éi form eksisterer som ein del av ei anna form.}
...
\prop{2.51}{d}{Affordansar er operasjoner materialet logisk og strukturelt tillét eller motset seg.}
...
\begin{widebody}
\begingroup\small
\refentry{Sullivan, L. H. (1896). The tall office building artistically considered. Lippincott's Magazine.}
...
with open('FORMLÆRE_09.04.2026.tex', 'w', encoding='utf-8') as f:
    f.write(content)
