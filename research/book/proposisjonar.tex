...
\prop{1.3}{d}{\textbf{Formrommet} (\textit{morphospace}) til ein klasse er mengda av alle hennar moglege konfigurasjonar.\textsuperscript{9,\,23} Kvart realisert objekt okkuperer eitt punkt i dette rommet. Det empiriske formrommet er alltid ein projeksjon;\textsuperscript{2} forma eksisterer uavhengig av målinga.}

\prop{1.31}{d}{Klassen avgrensar formrommet gjennom delt affordansestruktur:\textsuperscript{12} objekta i klassen tilbyr same konstellasjon av operasjonar til same konstellasjon av agentar. Klassen set grensene; seleksjonstrykket fordelar innhaldet.}

\prop{1.32}{d}{Morforommet er ein algebra lukka under union, differanse og transformasjon.\textsuperscript{11,\,13,\,20} Algebraen definerer kva operasjonar som er moglege.}
...
\prop{1.44}{d}{Dei tre regionane utgjer ein epistemisk partisjon:\textsuperscript{18,\,19} det \textbf{kjende} (K), det \textbf{tenkelege} (C\msym{∖}K), og det utenkjelege. Grensene er epistemiske, ikkje ontologiske.}
...
\prop{2.1}{d}{Eit \textbf{seleksjonstrykk} endrar sannsynsfordelinga i formrommet.\textsuperscript{3} Trykket er ein gradient, inga regel. Det avgrensar kvar posisjonen \textit{ikkje} kan vere. Forma er det som står att når trykka har utelukka alt anna.\textsuperscript{16}}
...
\prop{2.2}{d}{\textbf{Materialaffordansen} er operasjonane materialet tillèt og hindrar.\textsuperscript{12} Signaturen er latent; han bind sannsynsfordelinga utan å tvinge geometrien. Stål fanst i hundreår før røyrstolen fordi operasjonen mangla. Formhistoria er systematisk langsamare enn materialhistoria.}
...
\prop{3.1}{d}{\textbf{Tilpassingslandskapet} er vektorsummen av alle verksame seleksjonstrykk.\textsuperscript{3,\,7} Kvar posisjon held ein verdi: graden av samtidig forløysing for alle trykk.}
...
\prop{3.2}{d}{Stabiliteten til ein haug svarar til brattleiken på dalveggane.\textsuperscript{7} Bratte veggar tvingar fram kanalisering: forma støyter vekk forstyrringar. Dominante trykk faldar rommet til tronge korridorar. Djupe kanalar frys dimensjonane; grunne rommar fluktuasjonen.}
...
\prop{4.3}{t}{Landskapet har minne.\textsuperscript{15} Kvar realisert form endrar seleksjonstrykka for den neste. All formgjeving er omformgjeving; agenten startar aldri med blanke ark. Stiavhengigheit er eit fundamentalt trekk, ingen anomali.\textsuperscript{15}}
...
\prop{5.11}{d}{Ein \textbf{agent} er ein operator definert av trippelet: måltilstand, avstandsmåling, justeringsmekanisme.\textsuperscript{4,\,5,\,6} Agens krev berre organisering; verken medvit, intensjon eller nervesystem. Informasjonsflyt skil agentar frå passiv materie.}
...
\prop{5.2}{d}{\textbf{Kognitiv lyskjegle} er delmengda av formrommet agenten kan representere og manipulere.\textsuperscript{22} Alt utanfor lyskjegla manglar kausal eksistens for agenten. Lyskjegler spenner frå cellulær millisekundrespons til tiårslang konsensus.}
...
\prop{5.6}{d}{\textbf{Omsorg} er mengda av aksar i formrommet agenten aktivt representerer og justerer for.\textsuperscript{24} Ein agent som held tre dimensjonar i lyskjegla, navigerer eit rikare landskap enn ein agent som held éin. Den fyrste oppdagar kompromiss den andre ikkje veit finst. Den fyrste produserer former som toler fleire trykk samstundes.}

\prop{5.61}{t}{Omsorg er intelligensens innhald; intelligens er omsorgas form.\textsuperscript{24}}
...
\prop{6.12}{t}{Agens er multiskalar.\textsuperscript{22,\,25} Kvar skala har sin eigen kompetanse og si eiga lyskjegle. Formproduksjon er distribuert C\msym{↔}K-ekspansjon utført av grammatikkoperasjonar over kompetanseskalaer.}
