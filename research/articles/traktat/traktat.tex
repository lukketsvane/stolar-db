...
Thonet nr.~14 (1859) okkuperer eitt punkt i \textbf{\textit{formrommet}}. Over femti millionar eksemplar er produserte; ho er den mest reproduserte stolen i historia.

Objektet tilbyr sitting, stabling og transport til ein kafé, ein arbeidar og eit dampskip. Det er denne konstellasjonen av tilbod som definerer klassen; det er \textbf{\textit{affordansestrukturen}} (1.31).
...
Bøketreet tillèt mjuke kurver langs fiberen og vetoar sprø bøyingar; det er ein underordna \textbf{\textit{agent}} som navigerer materialdimensjonen utan representasjon av stolen som heilskap (5.4). Dampen opnar ein \textbf{\textit{forboden region}}: buktingar under 90\textdegree{} vert moglege gjennom temporær endring av \textbf{\textit{materialaffordansen}}. Thonet navigerer med ein \textbf{\textit{lyskjegle}} som rommar minst fire aksar samstundes: kostnad, monteringstid, transportvolum og visuell karakter. Ein agent med \textbf{\textit{omsorg}} for berre éin akse ville produsert ein stol som sviktar under dei andre.

Tanken «ein stol av bøygd heiltre» var i \textbf{\textit{konseptrommet}} før 1830. Thonet sine eksperiment flytta han til \textbf{\textit{kunnskapsrommet}}. Realiseringa opna nye regionar i konseptrommet: kva andre former kan dampbøygd tre ta? Det \textbf{\textit{nærliggande moglege}} ekspanderte. Stolen har vore i uavbroten produksjon i over 160 år; ho sit på ein bratt haug i \textbf{\textit{tilpassingslandskapet}} der kvart avsteg kostar.

Ettertida kallar nr.~14 ein «wienstol» og plasserer han i kategorien historisme. \textbf{\textit{Stilkategorien}} forklarer ingenting. Stolen vart ikkje forma av historismen. Historismen skildrar forma fossilt.

Men tinga me omgjev oss med, er ikkje fossil. Dei er levande; ofte forlenging av kroppane våre; nokre meir bokstavleg eller permanent enn andre. Stolen du sit i akkurat no navigerer framleis; ho responderer på vekta di, på temperaturen i rommet, på lyset som fell over ho. Ho er eit kompromiss mellom krefter som framleis verkar. Det som skil henne frå eit museumsobjekt, er at kompromisset enno ikkje er oppløyst. Ho fortener minst like mykje omsorg som det fossile.

\bigskip

Denne traktaten er sjølv ein konfigurasjon i eit intellektuelt formrom. Ho er navigert under sine eigne seleksjonstrykk; ho ber signaturen av det forfattaren brydde seg om; og ho er falsifiserbar.
