...
\prop{1.3}{d}{\textbf{Formrommet} (\textit{morphospace}) til ein klasse er mengda av alle hennar moglege konfigurasjonar.\textsuperscript{9,\,19} Kvart realisert objekt okkuperer eitt punkt i dette rommet. Det empiriske formrommet er alltid ein projeksjon; forma eksisterer uavhengig av målinga.}

\prop{1.31}{d}{Klassen avgrensar formrommet gjennom delt \textit{affordansestruktur}:\textsuperscript{11} objekta i klassen tilbyr same konstellasjon av operasjonar til same konstellasjon av agentar. Klassen set grensene; seleksjonstrykket fordelar innhaldet.}

\prop{1.32}{d}{Morforommet er ein \textit{formalgebra} lukka under union, differanse og transformasjon.\textsuperscript{10,\,12,\,17} Algebraen definerer kva operasjonar som er moglege.}
...
\prop{1.44}{d}{Dei tre regionane utgjer ein epistemisk partisjon:\textsuperscript{15,\,16} det \textbf{kjende} (K), det \textbf{tenkelege} (C\msym{∖}K), og det utenkjelege. Grensene er epistemiske, ikkje ontologiske.}
...
\prop{2.1}{d}{Eit \textbf{seleksjonstrykk} endrar sannsynsfordelinga i formrommet.\textsuperscript{3} Trykket er ein gradient, inga regel. Det avgrensar kvar posisjonen \textit{ikkje} kan vere. Forma er det som står att når trykka har utelukka alt anna.\textsuperscript{14}}
...
\prop{2.12}{a}{Fleire seleksjonstrykk verkar samstundes. Av 2.11 følgjer: med berre eitt trykk ville alle former vore identiske. Eit latent trykk verkar framleis; metoden krev variasjon i vilkåra.}

\prop{2.13}{a}{Minst to trykk peikar i motstridande retningar. Av 2.12 følgjer: kvar realisert form er eit kompromiss. Omgrepet «suboptimal» føreset ein referanse; utan eit spesifikt trykksett er det ikkje falsifiserbart.}

\prop{2.14}{t}{Affordansestrukturen definerer klassen. Av 1.31 følgjer: han er konstant innanfor klassen og ber difor null informasjon om kvifor éi form oppstod framfor ei anna. Dei resterande seleksjonstrykka driv all formvariasjon.}
...
\prop{2.2}{d}{\textbf{Materialaffordansen} er operasjonane materialet tillèt og hindrar.\textsuperscript{11} Signaturen er \textit{latent}; han bind sannsynsfordelinga utan å tvinge geometrien. Stål fanst i hundreår før røyrstolen fordi operasjonen mangla. Formhistoria er systematisk langsamare enn materialhistoria.}

\prop{2.21}{t}{Ein \textit{samlevariabel} predikerer formvariasjon betre enn einskildtrykk. Stilperioden er ein slik samlevariabel. Av 2.14 og 2.141 følgjer: stilen er ikkje ei forklaring; han er eit aggregat som absorberer alle samtidige trykk i éin etikett. Stilen antyder ein hovudfunksjon; men sidan me har vist at hovudfunksjonen er informasjonstom innanfor klassen (2.14), er stilen eit symptom på underliggjande krefter, ikkje ei årsak.}
...
\prop{3.1}{d}{\textbf{Tilpassingslandskapet} er vektorsummen av alle verksame seleksjonstrykk.\textsuperscript{3,\,6} Kvar posisjon held ein verdi: graden av samtidig forløysing for alle trykk.}
...
\prop{3.12}{t}{Av 2.12, 2.13 og 3.1 følgjer: tilpassingsfunksjonen har talrike lokale maksima. Landskapet er eit taggete massiv. Ein haug er staden der kvart avsteg kostar; dalar er tilstandane formene skyr. Éin universell topp er eit teoretisk unntak; empirien knuser postulatet om den eine perfekte forma.}

\prop{3.2}{d}{Stabiliteten til ein haug svarar til brattleiken på dalveggane.\textsuperscript{6} Bratte veggar tvingar fram \textit{kanalisering}: forma støyter vekk forstyrringar. Dominante trykk faldar rommet til tronge korridorar. Djupe kanalar frys dimensjonane; grunne rommar fluktuasjonen.}

\prop{3.3}{d}{Ein \textbf{stil} er forma si \textit{sverming} kring eit felles tyngdepunkt.\textsuperscript{8} Stilen er ein \textit{sverm}, ikkje ein kategori; grensene er naudsynleg uskarpe. Stilperiodar er gradientar, ikkje øyar.}
...
\prop{4.1}{a}{Seleksjonstrykka kviler aldri. Av 3.1 følgjer: haugar stig, søkk, flyttar seg, deler seg, smeltar saman. Optimal tilpassing er lokal i tid.}
...
\prop{4.3}{t}{Landskapet har minne.\textsuperscript{13} Kvar realisert form endrar seleksjonstrykka for den neste. All formgjeving er omformgjeving; agenten arvar alltid ein posisjon. \textit{Stiavhengigheit} er eit fundamentalt trekk, ingen anomali.}

\prop{4.4}{o}{Formrommet ekspanderer kumulativt. Det \textit{nærliggande moglege}\textsuperscript{12} er C\msym{∖}K-grensa: mengda av former som er tenkelege men ukjende som realiserbare. Materialstraumar driv landskapsendringa.}
...
\prop{5.11}{d}{Ein \textbf{agent} er ein operator definert av trippelet: måltilstand, avstandsmåling, justeringsmekanisme.\textsuperscript{4,\,5} Agens krev berre organisering; verken medvit, intensjon eller nervesystem. Informasjonsflyt skil agentar frå passiv materie.}
...
\prop{5.2}{d}{\textbf{Kognitiv lyskjegle} er delmengda av formrommet agenten kan representere og manipulere.\textsuperscript{20} Alt utanfor lyskjegla manglar kausal eksistens for agenten. Lyskjegler spenner frå cellulær millisekundrespons til tiårslang konsensus.}
...
\prop{5.3}{d}{Agenten manipulerer formgeometrien direkte. Konfigurasjonar lukka under union og snitt utgjer ein \textit{formalgebra}; \textbf{formgrammatikken}\textsuperscript{10} utfører diskrete overgangar i denne geometrien. Reglar fyrer på innleiring; inndatageometrien er einaste premiss.}
...
\prop{5.41}{i}{Biologisk vev navigerer via bioelektrisk polarisering;\textsuperscript{21,\,23} menneskeleg praksis via materiell friksjon; ein slimsopp via oscillerande samandragingar; ein språkmodell via vektoriell merksemd. Navigasjonsmekanikken er universell; kompetansen formelt ekvivalent.}
...
\prop{5.6}{d}{\textbf{Omsorg}\textsuperscript{22} er mengda av aksar i formrommet agenten aktivt representerer og justerer for. Ein agent som held tre dimensjonar i lyskjegla, navigerer eit rikare landskap enn ein agent som held éin. Den fyrste oppdagar kompromiss den andre ikkje veit finst.}

\prop{5.61}{t}{Omsorg er intelligensens innhald; intelligens er omsorgas form.\textsuperscript{22}}

\propcont{Av 5.2 og 5.6 følgjer: ein agent utan omsorg for ein dimensjon er blind for landskapets gradient langs den aksen. Blindskapen er ikkje nøytral: dei usynlege trykka verkar framleis. Forma som oppstår under redusert omsorg ber signaturen av det agenten ikkje såg; ho sviktar der ho aldri vart prøvd. Omsorga kan ikkje supplerast i ettertid; den måtte vore der då forma vart navigert.}

\prop{5.62}{t}{Av 5.61 følgjer: å utvide lyskjegla er ein etisk operasjon. Det er å ta fleire krefter med i kompromisset. Å snevra ho inn er å overlevere delar av formverda til krefter ingen representerer.}
...
\prop{6.1}{t}{Av 2.12 og 5.1 følgjer: fleire agentar responderer på ulike trykk samstundes. Kvar form er eit \textit{poly-agentisk kompromiss}. Ingen einskild agent dikterer morfologien; ho trer fram i skjeringspunktet mellom dei.}
...
\prop{6.12}{t}{Agens er \textit{multiskalar}.\textsuperscript{21} Kvar skala har sin eigen kompetanse og si eiga lyskjegle. Formproduksjon er distribuert C\msym{↔}K-ekspansjon utført av grammatikkoperasjonar over kompetanseskalaer.}
...
\prop{6.5}{t}{Inga form er endeleg. Av 2.13 og 4.1 følgjer: kvar balanse vert med tida suboptimal. Berre den generative strukturen varer: formrom, trykk, landskap, agentar. Formene er flyktige spor; grammatikken er stabil.}

\prop{6.6}{o}{Formverda er det tilfellet som verkar. Navigasjonen held fram.}

\flowchapter{7 Om det som ikkje lèt seg seie}{om det som ikkje lèt seg seie}
\mainprop{7}{}{Om det som ikkje lèt seg seie, lyt formgjevaren forme.}
