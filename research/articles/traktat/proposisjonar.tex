...
\prop{3.3}{d}{Ein \textbf{stil} er forma si sverming kring eit felles tyngdepunkt.\textsuperscript{8} Stilen er ein sverm, ikkje ein kategori; grensene er naudsynleg uskarpe. Stilperiodar er gradientar, ikkje øyar.}
...
\prop{4.3}{t}{Landskapet har minne.\textsuperscript{13} Kvar realisert form endrar seleksjonstrykka for den neste. All formgjeving er omformgjeving; agenten startar aldri med blanke ark. \textit{Stiavhengigheit} er eit fundamentalt trekk, ingen anomali.}

\prop{4.4}{o}{Formrommet ekspanderer kumulativt. Det \textit{tilstøytande moglege}\textsuperscript{12} er C\msym{∖}K-grensa: mengda av former som er tenkelege men ukjende som realiserbare. Materialstraumar driv landskapsendringa.}
