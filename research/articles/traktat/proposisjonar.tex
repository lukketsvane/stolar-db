...
\prop{1.31}{d}{Klassen avgrensar formrommet gjennom delt affordansestruktur:\textsuperscript{11} objekta i klassen tilbyr same konstellasjon av operasjonar til same konstellasjon av agentar. Klassen set grensene; seleksjonstrykket fordelar innhaldet.}

\prop{1.32}{d}{Morforommet er ein algebra lukka under union, differanse og transformasjon.\textsuperscript{10,\,12,\,17} Algebraen definerer kva operasjonar som er moglege.}
...
\prop{2.2}{d}{\textbf{Materialaffordansen} er operasjonane materialet tillèt og hindrar.\textsuperscript{11} Signaturen er latent; han bind sannsynsfordelinga utan å tvinge geometrien. Stål fanst i hundreår før røyrstolen fordi operasjonen mangla. Formhistoria er systematisk langsamare enn materialhistoria.}
...
\prop{3.2}{d}{Stabiliteten til ein haug svarar til brattleiken på dalveggane.\textsuperscript{6} Bratte veggar tvingar fram kanalisering: forma støyter vekk forstyrringar. Dominante trykk faldar rommet til tronge korridorar. Djupe kanalar frys dimensjonane; grunne rommar fluktuasjonen.}
...
\prop{4.3}{t}{Landskapet har minne.\textsuperscript{13} Kvar realisert form endrar seleksjonstrykka for den neste. All formgjeving er omformgjeving; agenten startar aldri med blanke ark. Stiavhengigheit er eit fundamentalt trekk, ingen anomali.}

\prop{4.4}{o}{Formrommet ekspanderer kumulativt. Det tilstøytande moglege\textsuperscript{12} er C\msym{∖}K-grensa: mengda av former som er tenkelege men ukjende som realiserbare. Materialstraumar driv landskapsendringa.}
...
\prop{5.3}{d}{Agenten manipulerer formgeometrien direkte. Konfigurasjonar lukka under union og snitt utgjer ein \textbf{formalgebra}; \textbf{formgrammatikken}\textsuperscript{10} utfører diskrete overgangar i denne geometrien. Reglar fyrer på innleiring; inndatageometrien er einaste premiss.}
...
\prop{5.6}{d}{\textbf{Omsorg}\textsuperscript{22} er mengda av aksar i formrommet agenten aktivt representerer og justerer for. Ein agent som held tre dimensjonar i lyskjegla, navigerer eit rikare landskap enn ein agent som held éin. Den fyrste oppdagar kompromiss den andre ikkje veit finst. Den fyrste produserer former som toler fleire trykk samstundes.}
...
\prop{6.12}{t}{Agens er multiskalar.\textsuperscript{21} Kvar skala har sin eigen kompetanse og si eiga lyskjegle. Formproduksjon er distribuert C\msym{↔}K-ekspansjon utført av grammatikkoperasjonar over kompetanseskalaer.}
