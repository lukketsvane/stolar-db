...
start_marker = r"\addcontentsline{toc}{chapter}{1 Form er ein posisjon i eit rom av moglegheiter}"
...
if start_idx == -1 or end_idx == -1:
    print('Markers not found! Trying fallback...')
    # Let's try to find \prop{1}
    start_idx = content.find(r"\prop{1}{}")
    if start_idx == -1:
        # Just find chapter 1 addcontentsline
        start_idx = content.find(r"\addcontentsline{toc}{chapter}{1 ")
    if start_idx == -1:
...
print("Chapter 1 rewritten successfully to match Tractatus style.")