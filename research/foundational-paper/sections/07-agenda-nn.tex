...
\textbf{4. Agentisk designverktøy-prototype} (frå proposisjon 6). Teorien impliserer ein spesifikk arkitektur for AI-assisterte designverktøy: mennesket set dei kognitive lyskjegleparametrane, og AI-en utfører formgrammatikkreglar innanfor den lyskjegla. Ei prototypeimplementering ville teste om kjeglebreidde korrelerer med designkvalitet.
