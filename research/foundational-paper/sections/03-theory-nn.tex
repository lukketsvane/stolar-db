...
Den fyrste proposisjonen ekkoar medvite opninga til Wittgenstein sitt \textit{Tractatus} \parencite{Wittgenstein1921}: der Wittgenstein byrjar med fakta, byrjar den noverande teorien med former. Teorien byrjar med ontologi. Eit \textbf{objekt} er den enklaste bestanddelen i ei form; udeleleg innanfor det valde analysenivået. Ein \textbf{konfigurasjon} er ei samansetjing av objekt; forma er strukturen til konfigurasjonen. Desse to definisjonane fester det analytiske substratet: teorien opererer på strukturelle relasjonar mellom delar, ikkje på delane sjølve.
