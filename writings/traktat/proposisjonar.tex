...
\begin{widebody}
{\small\noindent\textit{d\,=\,definisjon\quad a\,=\,postulat\quad t\,=\,teorem\quad o\,=\,observasjon\quad i\,=\,illustrasjon}}
\end{widebody}
\vspace{-4pt}
...
\prop{2.21}{t}{Ein \textit{samlevariabel} predikerer formvariasjon betre enn einskildtrykk. Stilperioden er ein slik samlevariabel. Av 2.14 og 2.141 følgjer at stilen ikkje er ei forklaring; han er eit aggregat som absorberer alle samtidige trykk i éin etikett. Stilen antyder ein hovudfunksjon; men sidan hovudfunksjonen er informasjonstom innanfor klassen (2.14), er stilen eit symptom på underliggjande krefter, ikkje ei årsak.}
...
\prop{5.6}{d}{\textbf{Omsorg}\textsuperscript{23} er mengda av aksar i formrommet agenten aktivt representerer og justerer for.}

\prop{5.61}{t}{Av 5.2 følgjer at agenten berre navigerer innanfor lyskjegla. Av 5.6 følgjer at omsorga avgjer kor mange aksar lyskjegla rommar. Ein agent med omsorg for tre dimensjonar oppdagar kompromiss ein agent med éin dimensjon ikkje veit finst. Den fyrste produserer former som toler fleire trykk samstundes. Den andre produserer former som sviktar langs dei aksane ho ikkje såg.}

\prop{5.62}{d}{Kompetansen til ein agent er evna til å navigere mot stabile posisjonar i landskapet. Av 5.61 følgjer at kompetansen veks med omsorga. Det me kallar intelligens, er nettopp denne kompetansen. Omsorg er difor intelligensen sitt innhald; intelligens er omsorga si form.\textsuperscript{23}}

\prop{5.63}{t}{Av 5.62 følgjer at ein agent utan omsorg for ein dimensjon er blind for landskapets gradient langs den aksen. Blindskapen er ikkje nøytral. Dei usynlege trykka verkar framleis. Forma som oppstår under redusert omsorg ber signaturen av det agenten ikkje såg; ho sviktar der ho aldri vart prøvd. Omsorga kan ikkje supplerast i ettertid; den måtte vore der då forma vart navigert.}

\prop{5.64}{t}{Av 5.62 følgjer at å utvide lyskjegla er ei etisk handling. Det er å ta fleire krefter med i kompromisset. Å snevra ho inn er å overlevere delar av formverda til krefter ingen representerer.}
