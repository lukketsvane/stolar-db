      ...
      <div className="min-h-screen bg-white text-black flex flex-col lg:flex-row overflow-hidden">
        <div className="lg:flex-1 flex flex-col relative h-screen bg-white">
          ...
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex gap-12 z-50">
            <button onClick={() => navigateTo('prev')} className="text-gray-300 hover:text-black transition-all">
              <ChevronLeft size={24} />
            </button>
            <button onClick={() => navigateTo('next')} className="text-gray-300 hover:text-black transition-all">
          ...
          <div className="max-w-md mx-auto space-y-16">
            <section>
              ...
              <div className="flex gap-4">
                <span className="font-mono text-[10px] font-black uppercase tracking-widest text-black">{currentItem.year}</span>
                <span className="font-mono text-[10px] font-black uppercase tracking-widest text-gray-300">{currentItem.location?.split(",")[0]}</span>
              </div>
            </section>
            ...
            <section className="pt-12">
              <a 
                ...
                className="flex items-center justify-center w-full border border-black/10 p-6 hover:bg-gray-50 transition-all group"
              >
                <img src="/nasjonalmuseet_logo.jpg" alt="Nasjonalmuseet" className="h-8 w-auto object-contain opacity-30 group-hover:opacity-100 transition-opacity" />
              </a>
            </section>
          </div>
        </aside>
    ...
    <div className="min-h-screen bg-white text-black font-sans selection:bg-black selection:text-white">
          ...
          <div className="flex gap-6">
            {[ "I", "II", "III", "IV", "V" ].map((n, i) => (
              <button 
                ...
                className="font-mono font-black text-sm tracking-widest hover:line-through"
              >
                {n}
              </button>
            ))}
      ...
      <div className="max-w-[2000px] mx-auto px-6 md:px-12 pt-48 pb-40">
        <div className="space-y-40">
          {Object.entries(groupedChairs).sort(([a], [b]) => b.localeCompare(a)).map(([century, chairs]) => (
            <section key={century}>
              <div className="flex items-baseline justify-between border-b border-black/10 pb-6 mb-12">
                ...
                <span className="font-mono text-sm font-bold text-gray-200 uppercase tracking-[0.2em]">{chairs.length} objekt</span>
              </div>
