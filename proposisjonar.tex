...
\propcont{C er konseptrommet: alle former som er tenkelege men ikkje avgjorte. K er kunnskapsrommet: alle former som er kjende å verke eller svikte. Design er rørsla mellom dei:}

\begin{center}\small
\begin{tabular}{l@{\hspace{4mm}}l@{\hspace{4mm}}l}
\textbf{Operator} & \textbf{Retning} & \textbf{Verknad} \\[2pt]
C\msym{→}C & partisjon & konseptet vert spesifisert \\
C\msym{→}K & realisering & konseptet vert avgjort \\
K\msym{→}K & deduksjon & ny kunnskap frå eksisterande \\
K\msym{→}C & konjunksjon & ny kunnskap opnar nye konsept \\
\end{tabular}
\end{center}
...
\prop{5.6}{d}{\textbf{Omsorg} (\textit{care}) er mengda av aksar i formrommet agenten aktivt representerer og justerer for. Ein agent som held tre dimensjonar i lyskjegla, navigerer eit rikare landskap enn ein agent som held éin. Den fyrste oppdagar kompromiss den andre ikkje veit finst. Den fyrste produserer former som toler fleire trykk samstundes.}
