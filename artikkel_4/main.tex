...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figurar/fig10_samanlikning_paradigme.png}
    \caption{Samanlikning av paradigme: Funksjonalisme mot Form Follows Fitness (FFF). FFF generaliserer funksjonalismen ved \aa{} inkludere materialaffordanse, tid og geografi som aktive seleksjonstrykk i eit m\aa{}lbart fitnesslandskap.}
    \label{fig:paradigme_samanlikning}
\end{figure}
