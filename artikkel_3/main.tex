...
\citet{finne2026a} synte at material i museumssamlingar er bunde til spesifikke nasjonal\o{}konomiske omstende; mahogni markerer internasjonale handelsnettverk, medan furu indikerer nordiske produksjonstilh\o{}ve. \citet{ingold2007} argumenterer for at materialar ikkje er passive substrat, men aktive akt\o{}rar som \emph{tvingar} visse former fram: b\o{}yd b\o{}k auka sannsynet for sirkul\ae{}re former, medan massivt eik disponerer for rektangul\ae{}r konstruksjon. \citet{miller2005} utvidar dette perspektivet til ein generell teori om materialitet der objekt og material konstituerer kvarandre gjensidig. \citet{gibson1977} sitt omgrep \emph{affordances}, altso dei handlingsm\o{}gelegheitene eit material tilbyr, gjev eit teoretisk rammeverk for kvifor me kan forvente systematisk kovarians mellom geometri og material. Dermed vert ikkje form berre ``form''; den vert eit symptom p\aa{} ei underliggjande materiell-formell kopling, der \citet{alexander1964} sine id\`{e}ar om samanheng mellom form og kontekst f\aa{}r empirisk grunnlag.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figurar/fig1_formrom.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figurar/fig2_klassefordeling.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{figurar/fig3_klassifikasjon.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figurar/fig4_forvirring.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{figurar/fig5_perklasse_f1.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{figurar/fig7_kopling.pdf}
...
Tre retningar peikar seg ut: (1)~Djupl\ae{}ring (PointNet, DGCNN) p\aa{} r\aa{} punktsskyer med augmentering for \aa{} kompensere for lite datasett. (2)~Kryssmuseum-validering med samlingar fr\aa{} Victoria \& Albert Museum og Vitra Design Museum. (3)~Temporell regresjon, det vil seie prediksjon av produksjons\aa{}r som kontinuerleg variabel, for \aa{} teste om form endrar seg gradvis eller i spr\aa{}ng mellom stilperiodar.
