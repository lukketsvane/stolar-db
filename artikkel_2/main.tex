...
Sullivan sin formulering \citep{sullivan1896} og Le~Corbusier sin maskinanalogi \citep{corbusier1923} deler eit premiss: at form er \emph{determinert} av noko anna (funksjon, rasjonalitet, maskinlogikk). Dei are deterministiske teoriar. \citet{pye1968} var mellom dei fyrste som eksplisitt utfordra dette. Hans skilje mellom \emph{workmanship of risk} og \emph{workmanship of certainty} viste at form alltid er delvis kontingent, avhengig av materialets oppf\o{}rsel, handverkarens dugleik og tilfeldigheiter i produksjonsprosessen.
...
\begin{enumerate}
    ...
    \item \textbf{Geometrisk kompleksitet}: Uttrykt som filstorleiken p\aa{} GLB-modellen i kilobyte. GLB-formatet komprimerer mesh-data proporsjonalt med topologisk kompleksitet: ein stol med many flatar, kurver og detaljar produserer ei st\o{}rre fil enn ein geometrisk enkel stol. Dette er ein indirekte, men skalerbar proxy for formkompleksitet som kan applikerast p\aa{} heile korpuset.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figurar/fig1_3d_dekning.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figurar/fig2_kompleksitet.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figurar/fig3_volum.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figurar/fig4_material_kompleksitet.png}
...
Samstundes aukar den stilistiske divergensen, noko som viser at fitness ikkje er det same som uniformitet. Innanfor det konvergerte dimensjonsomr\aa{}det er formvariasjonen framleis enorm. Organismen er tilpassa milj\o{}et; men many ulike organismar kan vere tilpassa same milj\o{}.
